    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getString(R.string.debug).equals("off")) {
            ...
            Map<Recipe, ExtraData> map = new HashMap<>();
                map.put(new Recipe(-1, -1, "Flaeskesteg", "meget lækker", new Date(), -1, "tags", new BigDecimal(5)), new ExtraData(new BigDecimal(37), new BigDecimal(12)));
                map.put(new Recipe(-1, -1, "Poelsemix", "meget lækker", new Date(), -1, "tags", new BigDecimal(5)), new ExtraData(new BigDecimal(42), new BigDecimal(5)));
                map.put(new Recipe(-1, -1, "Spaghetti Bolognese", "meget lækker", new Date(), -1, "tags", new BigDecimal(5)), new ExtraData(new BigDecimal(13), new BigDecimal(2)));
